...
const rolePermissionRoutes = require('./app/routes/rolePermissionRoute');
const guestRoutes = require('./app/routes/guestRoute');
...
app.use('/role_permission', rolePermissionRoutes);
