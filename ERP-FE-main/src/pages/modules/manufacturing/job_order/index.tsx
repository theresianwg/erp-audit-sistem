...
import { fetchAllJobOrders } from '@/pages/api/manufacturing/jobOrder/jobOrderSlice';
...
export default function ProductionOrderPage() {
  ...
  useEffect(() => {
    dispatch(fetchAllJobOrders() as any);
  }, [dispatch]);
                ...
                {selector.jobOrders.data &&
                  selector.jobOrders.data.map((jobOrder: any) => (
                    <tr key={jobOrder.id}>
                      ...
                      <td className="text-black">{jobOrder.po_id}</td>
                      <td className="text-black">{jobOrder.po_status}</td>
