...
import {newCoa} from "../../../../api/general_ledger/coa/coaSlice"

import React, {useState} from "react"
import { useRouter } from "next/router"
import CoaForm from "./components/coa_form";
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex flex-col w-full gap-3">
                <div className={`flex-1 p-8 mt-20 ${mainContentClass}`}>
                    <CoaForm title= "New Coa" handleCancel={handleCancel} handleChange={handleChange} handleSubmit={handleSubmit}/>
                </div>
            </div>
            <Footer />
        </div>
