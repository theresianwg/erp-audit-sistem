...
export default function CreateBSReport(){
    ...
    const handleSubmit = (e: any) => {
        ...
        router.push({
            pathname: "/modules/finance_and_accounting/report_management/cash_flow",
            // query: formData
        })
    }
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="flex flex-col w-full gap-3">
                <div className={`flex-1 p-8 mt-20 ${mainContentClass}`}>
                    <ReportForm title="Cash Flow Report" handleCancel={handleCancel} handleChange={handleChange} handleSubmit={handleSubmit}/>
                </div>
            </div>
            <Footer />
        </div>
