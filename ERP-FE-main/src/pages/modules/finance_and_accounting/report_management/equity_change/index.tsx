                        ...
                        <tbody>
                            ...
                            <tr style={{ height: '23px', verticalAlign:'top' }}>
                                ...
                                <td colSpan={6}
                                    style={{ paddingTop: '3px', paddingLeft: '5px', paddingRight: '5px', width: '539px', wordWrap: 'break-word', whiteSpace: 'nowrap', textIndent: '0px', textAlign: 'center' }}>
                                    <span
                                        style={{ fontFamily: 'Arial', color: '#990033', fontSize: '18px', lineHeight: '1.1499023', fontWeight: 'bold' }}>Perubahan Ekuitas Pemilik</span>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <tr style={{ height: '14px',verticalAlign:'top'  }}>
                                ...
                                <td style={{
                                    ...
                                    <span style={{
                                        ...
                                        &nbsp; &nbsp; Pendapatan Bersih {/* &nbsp buat tab */}
                                    </span>
                                </td>
                                <td></td>
                                <td
                            ...
                            <tr style={{ height: '14px',verticalAlign:'top'  }}>
                                ...
                                <td style={{
                                    ...
                                    <span style={{
                                        ...
                                        &nbsp; &nbsp; Investasi Kurun Periode{/* &nbsp buat tab */}
                                    </span>
                                </td>
                                <td></td>
                                <td
                            ...
                            <tr style={{ height: '14px', verticalAlign: 'top' }}>
                                ...
                                >
                                    Total Penambahan Ekuitas Pemilik
                                </span>
                                </td>
                                <td></td>
                                <td
